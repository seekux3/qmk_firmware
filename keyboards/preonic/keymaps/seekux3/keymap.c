...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  KC_CAPS, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_INS,  \
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | CAPS | Reset|      |      |      |      |      |TM_ON |TM_OFF| PSCR | SLCK |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, RESET,   DEBUG,   _______, _______, _______, _______, TERM_ON, TERM_OFF,KC_PSCR, KC_SLCK, KC_DEL,  \
